...
public class Soup2Activity extends AppCompatActivity {
    TextView textView1;
    TextView textView2;
    TextView textView3;
    TextView textView4;
    ...
    private List<String> loadRecipes() {
        ...
        disposables.add(menuRepository.getRecipes("https://www.10000recipe.com/recipe/list.html?cat4=54&order=reco&page=1")
                .subscribe(
                        menuItems -> {
